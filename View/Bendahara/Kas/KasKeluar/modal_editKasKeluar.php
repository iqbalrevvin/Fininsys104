<!-- Data Modal -->
<div class="modal fade " id="editKasKeluar<?= $kas->idKas ?>" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="card">
                <div class="body">
                    ...
                    <div class="input-group">
                        <div class="form-line">
                                <input type="date" id="tglKasKeluar<?= $kas->idKas ?>" class="form-control datepicker" 
                    ...
                    <div class="input-group">
                        <div class="form-line">
                            <input type="text" onkeypress="return inputAngka(event)" pattern="[0-9]+" class="form-control" maxlength="10" id="jmlKasKeluar<?= $kas->idKas ?>" placeholder="Masukan Hanya Angka | Contoh: 100000"
                    ...
                    <!--<span class="font-bold col-teal" id="convertKas">
                        ...
                        <button type="button" class="btn bg-grey waves-effect" data-dismiss="modal">
                            ...
                            <button type="button" value="<?= $kas->idKas ?>" 
                                    class="btnEditKasKlr btn bg-blue-grey waves-effect">
