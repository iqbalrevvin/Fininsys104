                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                ...
                                <small>Untuk informasi tentang keluhan, penambahan fitur, cara penggunaan, dll. Silahkan hubungi kami melalui kontak dibawah ini.</small>
                            </h2>
                        </div>
                        <div class="body">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading">Iqbal Revvin</h4> 
                                    - System Analyst & Software Engineer<br>
                                    - 0812-2314-2314<br>
