                ...
                <div class="table-responsive">
                 <table class="table table-bordered table-striped table-hover datatable">
                        ...
                        <tbody>
                            <?php
                                $no = 1; 
                                while($jenisKas=$dftJnsKasKlrQr->fetch_object()) :
                            ?>
                            <tr>
                                <td><?= $no++; ?></td>
                                ...
                                <td style="text-align: center; vertical-align: middle;">
                                    <button type="button" class="btn bg-teal btn-xs waves-effect" 
                                            data-toggle="modal" data-target="#editJnsKasKlr<?= $jenisKas->idJenis_kas ?>">  
                                        <i class="material-icons">mode_edit</i>
                                    </button>
                                    <button type="button" class="btn bg-pink btn-xs waves-effect btnDelJnsKasKlr" 
                            ...
                            <?php include "modal_editJenisKasKlr.php"; ?>
                            <?php endwhile; ?>
                        </tbody>
                    </table>
                </div>
