              ...
              <div class="row">
                <div class="col-lg-10" style="margin-top:10px;">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
						<form method="post" enctype="multipart/form-data" action="<?php echo "SI-Pembayaran?p=StudentList&k=upload"; ?>">
 ...
 if(!str_replace(" ","",$xnomer)==""){ 
  ...
  $gagal++;
  	  ...
  	  // setelah data dibaca, sisipkan ke dalam tabel mhs
		  $query = "INSERT INTO cbt_siswa (XNomerUjian, XNIK,XSesi,XRuang, XNamaSiswa,XKodeKelas, XJenisKelamin, XPassword, XPass, XKodeJurusan,
		  XKodeLevel, XFoto,XAgama,XSetId,XKodeSekolah,XPilihan) 
		  VALUES ('$xnomer', '$xnik','$xsesi', '$xruang', '$xnama','$xkelas','$xjekel',md5('$xpass'),'$xpass','$xjur','$xlevel','$xfoto','$xagama','$_COOKIE[beetahun]','$xidsek','$xpilih')";
