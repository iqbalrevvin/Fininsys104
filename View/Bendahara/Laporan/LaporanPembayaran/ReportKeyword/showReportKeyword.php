...
<?php 
	include "Controller/Bendahara/Laporan/LaporanPembayaran/ReportKeyword/reportKeywordQuery.php"; 
?>
<div class="header">
	<h2 style="text-align: center;">
    	...
    	<a href="View/Bendahara/Laporan/LaporanPembayaran/ReportKeyword/exportReportKeyword.php?keyword=<?php echo $keyword ?>&FD=<?php echo $FromDate ?>&ED=<?php echo $EndDate ?>">
...
<div id="invoice">
	...
	<h6 style="text-align: center;">
		<span>
			Kata Kunci : "<?= $keyword ?>" | Periode :&nbsp;<u><?php echo tgl_indo($FromDate) ?></u> s/d <u><?php echo tgl_indo($EndDate) ?></u>
		</span>&nbsp;
	</h6>
	<hr />
		...
		<tfoot>
			<tr style="height: 13.9375px;">
				...
				<?php $total=mysqli_query($db, "select SUM(jumlah_bayar) AS jumlah 
                                                          ...
                                                          AND jenis_transaksi.nama_jenis_transaksi LIKE '%$keyword%' 
                                                          OR master_transaksi.nama_master_transaksi = '%$keyword%'
                                                          ");
