...
$result = $db->query("SELECT * FROM siswa JOIN kelas ON kelas.nama_kelas = siswa.kelas
                                    ...
                                    WHERE master_transaksi.idMaster_transaksi = '$masterTransaksi' 
...
$judul = "Data Laporan Berdasarkan Master Transaksi | Jika Tampil -PROTECTED VIEW- Lakukan Pengaturan pada POLICY SETTINGS di Aplikasi Excel Anda Untuk Dapat Mengelola Data!";
