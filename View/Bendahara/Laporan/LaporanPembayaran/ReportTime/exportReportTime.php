...
$date = date('d-m-Y');
$namaFile = "ReportTimeTransaction-$date.xls";
//pengaturan judul data
$judul = "Data Laporan Berdasarkan Tanggal Transaksi | Jika Tampil -PROTECTED VIEW- Lakukan Pengaturan pada POLICY SETTINGS di Aplikasi Excel Anda Untuk Dapat Mengelola Data!";
...
xlsWriteLabel($tablebody,$kolombody++,tgl_indo($data['tgl_transaksi']));
