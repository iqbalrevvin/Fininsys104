<h4 style="text-align: center;">
	...
	<h6 style="text-align: center;">
		<span>
			Jenis Tunggakan : "Semua Tunggakan Khusus Tambahan" | Tahun Angkatan : "<?= $thnAngkatan ?>" | Kelas : "<?= $kelas ?>"
		</span>&nbsp;
	</h6>
	<hr />
		...
		<tfoot>
			<tr style="height: 13px;">
				...
				<th style="width: 0px; text-align: center; height: 13px; vertical-align: middle;" colspan="5">
					...
					Jumlah Semua Tunggakan Khusus : <b>Rp.<?= number_format($jmlSeluruhTunggakan) ?>.-</b>
				</th>
