<?php 
	include"Controller/Bendahara/Laporan/LaporanKas/KasKhusus/reportSpecialCashQr.php";
...
<div class="header">
	<h2 style="text-align: center;">
    	...
    	<a href="View/Bendahara/Laporan/LaporanKas/KasKhusus/exportReportCashSpecial.php?Master=<?php echo $masterKas ?>&FD=<?php echo $FromDate ?>&ED=<?php echo $EndDate ?>">
