...
(function($) {
    ...
    $.sessionTimeout = function(options) {
        var defaults = {
            title: 'Waktu Iddle & Sesi Login Habis!',
            message: 'Anda Akan Logout Otomatis Dalam Waktu 10 Detik. <br>Silahkan Lakukan aktivitas Kembali Pada Sistem Untuk Melanjutkan!.',
            logoutButton: 'Logout',
        ...
        if (typeof opt.onWarn !== 'function') {
            ...
            var coundownBarHtml = opt.countdownBar ?
                '<div class="progress"> \
                  <div class="progress-bar bg-blue-grey progress-bar-striped countdown-bar active" role="progressbar" style="min-width: 15px; width: 100%;"> \
              ...
              <div class="modal-dialog"> \
                <div class="modal-content"> \
                  <div class="modal-header"> \
                    ...
                    <i class="material-icons">lock</i> <i class="material-icons">lock</i> <i class="material-icons">lock</i> \
                    <i class="material-icons">lock</i> <i class="material-icons">lock</i> <i class="material-icons">lock</i> \
                    <i class="material-icons">lock</i> <i class="material-icons">lock</i> <i class="material-icons">lock</i> \
